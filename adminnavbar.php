...
<body class="bg-gray-100">
  ...
  <div class="max-w-screen-xl mx-auto px-4 flex justify-between">
    <a class="text-gray-700 flex flex-col items-center py-2 text-xs" href="adminhome.php">
      <i class="fas fa-home mb-1"></i> Home
    </a>
    <a class="text-gray-700 flex flex-col items-center py-2 text-xs" href="adminalbum.php">
      <i class="fas fa-images mb-1"></i> Album
    </a>
    <a class="text-gray-700 flex flex-col items-center py-2 text-xs" href="adminfoto.php">
    <i class="fas fa-image mb-1"></i> Foto
    </a>
    <a class="text-gray-700 flex flex-col items-center py-2 text-xs" href="adminusers.php">
    <i class="fas fa-user mb-1"></i> User
    </a>
