        ...
        <div class="w-full max-w-md bg-white shadow-md rounded px-8 py-8">
            ...
            <form action="" method="post">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between mb-4">
                    <button type="submit" class="w-full md:w-auto bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mb-2 md:mb-0">Submit</button>
                    <a href="login.php" class="text-blue-500 hover:underline text-center md:text-right">Back to Login</a>
                </div>
            </form>
        </div>
    </div>
