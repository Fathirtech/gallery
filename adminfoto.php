                ...
                <table class="w-full">
                    <tr>
                        ...
                        <td><input type="text" name="judulfoto"
                                class="border p-2 rounded w-full focus:outline-none focus:ring focus:border-blue-300">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="file" name="lokasifile"
                                class="border p-2 rounded w-full focus:outline-none focus:ring focus:border-blue-300">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="submit" value="Tambah"
                                class="bg-blue-500 text-white px-4 py-2 rounded cursor-pointer hover:bg-blue-600"></td>
                    </tr>
                </table>
            </div>
        </form>
            ...
            <div
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-between items-center mt-4">
                        <a href="hapus_foto.php?fotoid=<?= $data['fotoid'] ?>" class="text-red-500 hover:underline"><i
