    ...
    <div class="container mx-auto mt-8 p-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            while ($data = mysqli_fetch_array($sql)) {
                ?>
                <div
                    class="bg-white border rounded-md overflow-hidden shadow-md transform transition-transform ease-in-out hover:scale-105">
                    <div class="p-4">
                        <a href="album_detail.php?albumid=<?= $data['albumid'] ?>" class="block">
                            ...
                            <p class="text-xs text-gray-500">Tanggal dibuat:
                                <?= $data['tanggaldibuat'] ?>
                            </p>
                        </a>
                        <div class="mt-4 flex justify-between">
                            ...
                            <a href="edit_album.php?albumid=<?= $data['albumid'] ?>"
                                class="text-blue-500 hover:underline"><i class="fa-solid fa-pen-to-square"></i></a>
                        </div>
                    </div>
                </div>
                <?php
